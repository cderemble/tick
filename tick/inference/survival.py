...
class Survival:
    """A class that implements a number of estimators that are often used within
    survival analysis.
    """

    @staticmethod
    def kaplan_meier_survival_function(timestamps, event_observed):
    ...
    @staticmethod
    def nelson_aalen_hazard_rate(timestamps, event_observed):
